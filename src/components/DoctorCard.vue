<template>
    <div class="doctor-card" ref="card">
        <div class="doctor-card-normal" @click="focus=true" v-if="!focus">
            <img class="doctor-image" :src="profileImage"
                alt="" >
            <div class="doctor-details">
                <p class="doctor-name">
                    {{data['first_name']}} {{data['last_name']}}
                </p>
                <p class="doctor-specialization">{{data['specialization']['name']}}</p>
            </div>
        </div>
        <div class="doctor-card-focus" v-if="focus">
            <div class="doctor-brief">
                <img :src="profileImage"
                    alt="" class="doctor-image">
                <p class="doctor-name">{{data['first_name']}} {{data['last_name']}}</p>
                <p class="doctor-specialization">{{data['specialization']['name']}}</p>
            </div>
            <div class="separator"></div>
            <div class="doctor-education">
                <div class="detail-container">
                    <p class="detail-title">Degree</p>
                    <p class="detail-content">MBBBS</p>
                </div>
                <div class="detail-container">
                    <p class="detail-title">Speciality</p>
                    <p class="detail-content">{{data['specialization']['name']}}</p>
                </div>
                <div class="detail-container">
                    <p class="detail-title">Located</p>
                    <p class="detail-content">Masimu clinic</p>
                </div>
                <div class="doctor-focus-close" @click="focus=false">
                    <i class="fa fa-close"></i>
                </div>
                <div class="book-doctor" @click="$emit('open',data)">
